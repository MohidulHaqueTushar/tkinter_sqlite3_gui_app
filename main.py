...
def my_portfolio():
    ...
    def insert_coin():
        ...
        con.commit()
        messagebox.showinfo("Success:", "Coin Added to Portfolio!")
        reset()
    ...
    def update_coin():
        ...
        con.commit()
        messagebox.showinfo("Success:", "Coin Update to Portfolio!")
        reset()

    def delete_coin():
        cursorObj.execute("DELETE FROM coin WHERE id=?", (portid_delete.get(),))
        con.commit()
        messagebox.showinfo("Success:", "Coin Deleted from Portfolio!")
        reset()
